    ...
    try {
      ...
      const category = categories.find(
        (category: ProductCategoryTypes) =>
          category.id.toString() === formdata.category_id.toString()
      )
      const unit = units.find(
        (unit: ProductUnitTypes) =>
          unit.id.toString() === formdata.unit_id.toString()
      )
      const updatedData = {
        ...newData,
        id: data[0].id,
        rdt_users: { name: user.name, avatar_url: user.avatar_url },
        rdt_product_categories: category,
        rdt_product_units: unit,
      }
                    ...
                    <div className="w-full">
                      ...
                      <div>
                        <select
                          ...
                          {categories.map(
                            (category: ProductCategoryTypes, index) => (
                              <option
                                key={index}
                                value={category.id}>
                                {category.name}
                    ...
                    <div className="w-full">
                      ...
                      <div>
                        <input
                          ...
                          className="app__select_standard"
                        />
                        {errors.available_stocks && (
                          <div className="app__error_message">
                            Available Stocks is required
                          </div>
                        )}
                      </div>
                    </div>
