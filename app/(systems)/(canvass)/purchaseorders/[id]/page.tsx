...
import { Sidebar, TopBar, Title, Unauthorized, CustomButton, BackButton, Remarks, ConfirmModal } from '@/components'
    ...
    try {
      ...
      const { error: logError } = await supabase
        ...
        .insert({
          ...
          type: 'purchase_order',
          reply_type: 'system',
          message: `Removed an item "${item?.product_name}"`,
                  ...
                  <table className="app__table">
                    <thead className="app__thead">
                      <tr>
                        ...
                        <th className='app__th'>Product Description</th>
