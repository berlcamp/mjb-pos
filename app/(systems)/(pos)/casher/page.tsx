              ...
              <div className="">
                <div className="relative flex items-center">
                  <div className="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                    <svg
                      className="w-7 h-7 text-gray-500 -400"
                      aria-hidden="true"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                                  ...
                                  (product: ProductTypes, index: number) => (
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <div className="text-[10px] font-light text-white">
                                          {product.rdt_product_categories?.name}
                                        </div>
                                      </th>
                                      ...
                                      <td className="py-2 px-6">
                                        {Number(product.available_stocks) <
                                        1 ? (
                                          <span className="px-1 py-px bg-white rounded-full text-gray-700">
                                            Out of Stock
                                          </span>
                                        ) : (
                                          <span>
