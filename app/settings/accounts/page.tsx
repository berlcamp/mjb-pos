        ...
        <div>
          ...
          {!isDataEmpty && list.length === 8 && (
            <div className="app__warning_text">
              <span className="app__warning_title">Warning:</span> Maximum login
              account limit of 3 reached. You need to upgrade your account to
              create more login accounts.
            </div>
          )}
