            ...
            <div className='app__content'>
              {
                results && (
                  ...
                  <SelectUserNames handleManagerChange={handleManagerChange} multiple={true} type='purchase_orders' settingsData={Array.isArray(settingsData) ? settingsData.filter((item: settingsDataTypes) => item.access_type === 'purchase_orders') : []} title='Who can manage Purchase Orders'/>
