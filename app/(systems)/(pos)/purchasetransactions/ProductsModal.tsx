        ...
        <div className="app__modal_wrapper2_medium">
          <div className="app__modal_wrapper3">
            <div className="app__modal_header">
              <h5 className="app__modal_header_text">Products Purchased</h5>
              <button
                onClick={hideModal}
                type="button"
                ...
                <table className="app__table">
                  <thead className="app__thead">
                    <tr>
                      ...
                      <th className="hidden md:table-cell app__th">Quantity</th>
                      <th className="hidden md:table-cell app__th">Total</th>
                    </tr>
                  </thead>
                  <tbody>
                    {sales.map((item: SalesTypes, index: number) => (
                      <tr
                        ...
                        <th className="app__td">
                          ...
                          <div>
                            <div className="md:hidden app__td_mobile">
                              <div>Cost: {item.rdt_products?.cost}</div>
                        ...
                        <td className="hidden md:table-cell app__td">
                          <div>{item.rdt_products?.cost}</div>
                        </td>
                        <td className="hidden md:table-cell app__td">
