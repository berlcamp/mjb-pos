      ...
      <ul className="pt-4 mt-4 space-y-2 border-gray-700">
        ...
        <li>
          <Link
            ...
            className={`app__menu_link ${
              currentRoute.includes('casher') ? 'app_menu_link_active' : ''
            }`}>
        ...
        <li>
          <Link
            ...
            className={`app__menu_link ${
              currentRoute.includes('purchasetransactions')
        ...
        <li>
          <Link
            href="/productssold"
            className={`app__menu_link ${
              currentRoute.includes('productssold')
                ? 'app_menu_link_active'
                : ''
            }`}>
          ...
          <ul className="pt-8 mt-4 space-y-2 border-gray-700">
            ...
            <li>
              <Link
                href="/salesreport"
                className={`app__menu_link ${
                  currentRoute.includes('salesreport')
                    ? 'app_menu_link_active'
                    : ''
                }`}>
                <span className="flex-1 ml-3 whitespace-nowrap">
          ...
          <ul className="pt-8 mt-4 space-y-2 border-gray-700">
            ...
            <li>
              <Link
                ...
                className={`app__menu_link ${
                  currentRoute === '/productcategories'
                    ? 'app_menu_link_active'
                    : ''
                }`}>
                <span className="flex-1 ml-3 whitespace-nowrap">
            ...
            <li>
              <Link
                href="/productunits"
                className={`app__menu_link ${
                  currentRoute === '/productunits' ? 'app_menu_link_active' : ''
                }`}>
                <span className="flex-1 ml-3 whitespace-nowrap">
                  Product Units
                </span>
